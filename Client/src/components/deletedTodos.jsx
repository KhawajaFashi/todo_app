...
const DeletedTodos = () => {
    ...
    useEffect(() => {
        const fetchTodos = async () => {
            try {
                const response = await axios.get("http://localhost:3000/api/getDeletedTodos");
        ...
        <div className="flex-col justify-center items-center">
            <div>
                {todos.map((todo, index) => (
                    <div key={index} className="flex p-3 m-4 gap-5 items-center justify-center bg-red-500">
